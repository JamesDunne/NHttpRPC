...
namespace System
{
    ...
    public sealed class Memoizer<T1, TResult>
    {
        ...
        /// </summary>
        public TResult Set(TResult newValue, T1 t1)
        {
            // Construct a key for look-up:
            Key key = new Key(t1);
        ...
        public bool TryGetValue(T1 t1, out TResult val)
        {
            // Construct a key for look-up:
            Key key = new Key(t1);
    ...
    public sealed class Memoizer<T1, T2, TResult>
    {
        ...
        /// Sets a specific value to be returned for the given parameter values.
        /// </summary>
        public TResult Set(TResult newValue, T1 t1, T2 t2)
        {
            // Construct a key for look-up:
            Key key = new Key(t1, t2);
		...
		/// <param name="val">Output value to use if function returned true</param>
		/// <returns>false if no previous invocation was done</returns>
        public bool TryGetValue(T1 t1, T2 t2, out TResult val)
        {
            // Construct a key for look-up:
            Key key = new Key(t1, t2);
    ...
    public sealed class Memoizer<T1, T2, T3, TResult>
    {
        ...
        /// Sets a specific value to be returned for the given parameter values.
        /// </summary>
        public TResult Set(TResult newValue, T1 t1, T2 t2, T3 t3)
        {
            // Construct a key for look-up:
            Key key = new Key(t1, t2, t3);
		...
		/// <param name="val">Output value to use if function returned true</param>
		/// <returns>false if no previous invocation was done</returns>
        public bool TryGetValue(T1 t1, T2 t2, T3 t3, out TResult val)
        {
            // Construct a key for look-up:
            Key key = new Key(t1, t2, t3);
    ...
    public sealed class Memoizer<T1, T2, T3, T4, TResult>
    {
        ...
        /// Removes the last computed value for the given parameter values, if any.
        /// </summary>
        public void Remove(T1 t1, T2 t2, T3 t3, T4 t4)
        {
            if (_values == null) return;
        ...
        /// Sets a specific value to be returned for the given parameter values.
        /// </summary>
        public TResult Set(TResult newValue, T1 t1, T2 t2, T3 t3, T4 t4)
        {
            // Construct a key for look-up:
            Key key = new Key(t1, t2, t3, t4);
		...
		/// <param name="val">Output value to use if function returned true</param>
		/// <returns>false if no previous invocation was done</returns>
        public bool TryGetValue(T1 t1, T2 t2, T3 t3, T4 t4, out TResult val)
        {
            // Construct a key for look-up:
            Key key = new Key(t1, t2, t3, t4);
    ...
    public sealed class Memoizer<T1, T2, T3, T4, T5, TResult>
    {
        ...
        /// Removes the last computed value for the given parameter values, if any.
        /// </summary>
        public void Remove(T1 t1, T2 t2, T3 t3, T4 t4, T5 t5)
        {
            if (_values == null) return;
        ...
        /// Sets a specific value to be returned for the given parameter values.
        /// </summary>
        public TResult Set(TResult newValue, T1 t1, T2 t2, T3 t3, T4 t4, T5 t5)
        {
            // Construct a key for look-up:
            Key key = new Key(t1, t2, t3, t4, t5);
		...
		/// <param name="val">Output value to use if function returned true</param>
		/// <returns>false if no previous invocation was done</returns>
        public bool TryGetValue(T1 t1, T2 t2, T3 t3, T4 t4, T5 t5, out TResult val)
        {
            // Construct a key for look-up:
            Key key = new Key(t1, t2, t3, t4, t5);
    ...
    public sealed class Memoizer<T1, T2, T3, T4, T5, T6, TResult>
    {
        ...
        /// Removes the last computed value for the given parameter values, if any.
        /// </summary>
        public void Remove(T1 t1, T2 t2, T3 t3, T4 t4, T5 t5, T6 t6)
        {
            if (_values == null) return;
        ...
        /// Sets a specific value to be returned for the given parameter values.
        /// </summary>
        public TResult Set(TResult newValue, T1 t1, T2 t2, T3 t3, T4 t4, T5 t5, T6 t6)
        {
            // Construct a key for look-up:
            Key key = new Key(t1, t2, t3, t4, t5, t6);
		...
		/// <param name="val">Output value to use if function returned true</param>
		/// <returns>false if no previous invocation was done</returns>
        public bool TryGetValue(T1 t1, T2 t2, T3 t3, T4 t4, T5 t5, T6 t6, out TResult val)
        {
            // Construct a key for look-up:
            Key key = new Key(t1, t2, t3, t4, t5, t6);
    ...
    public sealed class Memoizer<T1, T2, T3, T4, T5, T6, T7, TResult>
    {
        ...
        /// Removes the last computed value for the given parameter values, if any.
        /// </summary>
        public void Remove(T1 t1, T2 t2, T3 t3, T4 t4, T5 t5, T6 t6, T7 t7)
        {
            if (_values == null) return;
        ...
        /// Sets a specific value to be returned for the given parameter values.
        /// </summary>
        public TResult Set(TResult newValue, T1 t1, T2 t2, T3 t3, T4 t4, T5 t5, T6 t6, T7 t7)
        {
            // Construct a key for look-up:
            Key key = new Key(t1, t2, t3, t4, t5, t6, t7);
		...
		/// <param name="val">Output value to use if function returned true</param>
		/// <returns>false if no previous invocation was done</returns>
        public bool TryGetValue(T1 t1, T2 t2, T3 t3, T4 t4, T5 t5, T6 t6, T7 t7, out TResult val)
        {
            // Construct a key for look-up:
            Key key = new Key(t1, t2, t3, t4, t5, t6, t7);
        ...
        public TResult this[T1 t1, T2 t2, T3 t3, T4 t4, T5 t5, T6 t6, T7 t7]
        {
            ...
            set
            {
                Set(value, t1, t2, t3, t4, t5, t6, t7);
            }
        }
    }
    ...
    public sealed class Memoizer<T1, T2, T3, T4, T5, T6, T7, T8, TResult>
    {
        ...
        /// Removes the last computed value for the given parameter values, if any.
        /// </summary>
        public void Remove(T1 t1, T2 t2, T3 t3, T4 t4, T5 t5, T6 t6, T7 t7, T8 t8)
        {
            if (_values == null) return;
        ...
        /// Sets a specific value to be returned for the given parameter values.
        /// </summary>
        public TResult Set(TResult newValue, T1 t1, T2 t2, T3 t3, T4 t4, T5 t5, T6 t6, T7 t7, T8 t8)
        {
            // Construct a key for look-up:
            Key key = new Key(t1, t2, t3, t4, t5, t6, t7, t8);
		...
		/// <param name="val">Output value to use if function returned true</param>
		/// <returns>false if no previous invocation was done</returns>
        public bool TryGetValue(T1 t1, T2 t2, T3 t3, T4 t4, T5 t5, T6 t6, T7 t7, T8 t8, out TResult val)
        {
            // Construct a key for look-up:
            Key key = new Key(t1, t2, t3, t4, t5, t6, t7, t8);
        ...
        public TResult this[T1 t1, T2 t2, T3 t3, T4 t4, T5 t5, T6 t6, T7 t7, T8 t8]
        {
            ...
            set
            {
                Set(value, t1, t2, t3, t4, t5, t6, t7, t8);
            }
        }
    }
