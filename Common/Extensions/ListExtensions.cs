...
namespace System.Collections.Generic
{
    public static class ListExtensions
    {
        ...
        /// <returns></returns>
        public static IEnumerable<TResult> FromOrderedGroupsKey<T, TGroupKey, TResult>(
            this IEnumerable<T> source,
            Func<T, TGroupKey> getGroupKey,
            Func<TGroupKey, List<T>, TResult> selectGroup
        )
        {
            return FromOrderedGroupsKeyComparer(source, getGroupKey, (Func<TGroupKey, TGroupKey, bool>)null, selectGroup);
        }
        ...
        /// <param name="selectGroup">Gets an instance to pair a group with its data</param>
        /// <returns></returns>
        public static IEnumerable<TResult> FromOrderedGroupsKeyComparer<T, TGroupKey, TResult>(
            this IEnumerable<T> source,
            Func<T, TGroupKey> getGroupKey,
        ...
        /// <param name="selectGroup">Gets an instance to pair a group with its data</param>
        /// <returns></returns>
        public static IEnumerable<TResult> FromOrderedGroupsKeyValue<T, TGroupKey, TGroupValue, TResult>(
            this IEnumerable<T> source,
            Func<T, TGroupKey> getGroupKey,
        ...
        {
            return FromOrderedGroupsKeyComparerValue(source, getGroupKey, null, getGroupValue, selectGroup);
        }
        ...
        /// <param name="selectGroup">Gets an instance to pair a group with its data</param>
        /// <returns></returns>
        public static IEnumerable<TResult> FromOrderedGroupsKeyComparerValue<T, TGroupKey, TGroupValue, TResult>(
            this IEnumerable<T> source,
            Func<T, TGroupKey> getGroupKey,
            Func<TGroupKey, TGroupKey, bool> groupKeyComparer,
            Func<T, TGroupValue> getGroupValue,
